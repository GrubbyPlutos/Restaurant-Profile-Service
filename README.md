...
#### PostgreSQL: <br />
<img src="/screenshots/000_read-query-postgres.png" alt="PostgreSQL simple SELECT query execution time." width="500px" height="370px">
<br />

#### Cassandra:<br />
<img src="/screenshots/010_read-query-cassandra.png" alt="Cassandra simple SELECT query execution time." width="500px" height="370px">
<br />
...
<img src="/screenshots/020_metrics-w/o-caching.png" alt="New Relic Dashboard showing number of transactions." width="500px" height="370px">
<br />
...
<br />
<img src="/screenshots/050_metrics-w/caching-and-w/o-caching-side-by-side.png" alt="Before and after using in-memory Redis cache." width="500px" height="370px">
<br />
...
<img src="/screenshots/070_2-servers-w/-LB.png" alt="2 host servers." width="500px" height="370px">
<br />

then, 5!<br />
<img src="/screenshots/080_100K_throughput_with_5_servers.png" alt="5 host servers." width="500px" height="370px">
<br />

Here, the servers:<br />
<img src="/screenshot/081_5-servers.png" alt="Individual server throughput, error rate, response time and CPU usage." width="500px" height="370px">
<br />
...
<img src="/screenshot/100_RPS-w/o-pool.png" alt="Using k6 to benchmark before connecting to the pool." width="500px" height="370px">
<br />

#### Results after to a pool:<br />
<img src="/screenshot/110_RPS-w/-Pool.png" alt="Using k6 to benchmark after connecting to the pool." width="500px" height="370px">
<br />
...
<img src="/screenshot/112_RPM-NewRelic.png" alt="Final results." width="500px" height="370px">
<br />
